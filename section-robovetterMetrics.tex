...
[If there are 3 transits and one of them has insufficient data, this metric would not fail the TCE. Is there another metric that would?]
...
If a TCE is deemed transit-like by passing all of the tests presented in \S\ref{nottransitlikesec} on both detrendings, it is given a KOI number.
...
[Should Pr be rint(Pb/Pa) instead of rint(Pa/Pb)?]
