\label{s:robovetter}
The dispositioning of the TCEs into the categories of PC and FP is entirely automated and is performed by the Robovetter\footnotemark[\ref{rvgithubfn}]. This code uses a variety of metrics to evaluate the TCEs and disposition them into PCs and FPs.  
