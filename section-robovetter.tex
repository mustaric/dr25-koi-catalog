...
The Centroid Robovetter gives the \kepler\ Robovetter several flags to indicate whether a centroid offset was detected and if that detection can be trusted. The reasons for the centroid robovetter are passed along in the minor flags defined in \S\ref{s:minorflags}.
...
NEED TO LIST WHICH METRICS actually GO INTO THE TUNING
