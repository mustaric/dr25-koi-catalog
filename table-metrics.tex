...
\hline\\
Planet Occultation & \ref{s:sscand} & SS \tablenotemark{\tiny{PC}} & \spcell{PLANET\_OCCULT\_DV\\PLANET\_OCCULT\_ALT} & Significant secondary could be caused by planet occultation.\\
\hline\\
Planet At Half Period & \ref{s:sscand} & - \tablenotemark{\tiny{PC}} & \spcell{PLANET\_PERIOD\_IS\_HALF\_DV\\PLANET\_PERIOD\_IS\_HALF\_ALT} & Planet scenario possible at half the DV period.\\
\hline\\
...
\enddata
\tablecomments{More details about all of these tests and how they are used by the Robovetter can be found in \S\ref{s:metrics} }
\label{t:metrics}
