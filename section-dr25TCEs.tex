...
\begin{figure}[h!]
 \begin{center}
  ...
  \caption{Histogram of the log$_{10}$(period) in days of the \opstce{s} (black). The DR24 catalog obsTCEs \citet{Seader2015} are shown in green for comparison. The number of long period TCEs is much larger for DR25, requiring a more effective Robovetter than in DR24.}
