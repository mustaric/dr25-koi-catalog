...
To summarize, for DR25 the number of false signals among the \opstce{s}  is dramatically larger than in any previous catalog. This was done on purpose in order to increase the Pipeline completeness.  As a result, we expect the \opstce\ list to contain more true exoplanets than before.   
