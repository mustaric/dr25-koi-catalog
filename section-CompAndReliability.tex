...
\begin{center}
\begin{tabular}{c}
\includegraphics[width=0.9\linewidth]{f8-top.pdf} \\
\includegraphics[width=0.9\linewidth]{f8-middle.pdf} \\
\includegraphics[width=0.9\linewidth]{f8-bottom.pdf}
\end{tabular}
