...
\begin{center}
\begin{tabular}{c}
\includegraphics[width=0.94\linewidth]{fig-AllCompletePmes-trimmed.png} \\[12pt]
\includegraphics[width=0.94\linewidth]{fig-AllEffect-Pmes-trimmed.png} \\[12pt]
\includegraphics[width=0.94\linewidth]{fig-AllReliabilityPmes-trimmed.png}
\end{tabular}
