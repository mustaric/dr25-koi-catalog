...
\item Write a conclusions Section [Susan started..opinions on topics to cover are welcome]

\item Robovetter Flag definitions in Appendix B
...
\item One sentence on the FPWG and how we disagree at time and that they use follow-up -- Combine with Confirmed planet table.
...
\item Describe where to find products used in this paper. [SUSAN]
