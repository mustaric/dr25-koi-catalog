...
To Do List:
\begin{itemize}
\item Introduction including a summary of what's new here
\item Table of our results
\item Table of INV/SCR cleaned objects
\item Discussion of where Robovetter needs improvements -- specific known failures.
\item optimization of the catalog [STEVE and JEFF]
\item INJ-TCEs in more detail [JESSIE]
\item CHASES description
\item Discussion/List of Confirmed that Failed.
\item Multi-Planet Systems
\item How to use all this information to do occurrence rates (basically)
...
\begin{itemize}
\item exact reasons each confirmed planet failed the robovetter.[just see NExScI]
