...
Because of the \Kepler\ data, the landscape of known exoplanets has expanded to include exoplanets as small as Kepler-69c?, a moon sized planet in a XX day period. The dataset also includes exoplanets in the habitable zone of their star, e.g. Kepler-Kepler-186d? or Kepler-452a. It also now includes exoplanets orbiting binary or triple systems.  And Kepler has found extremely compact systems such as Kepler-16, with 6 exoplanets all with periods less than XX days. 

And for each of these unique systems, there are a plethora of exoplanets This plethora of planets \Kepler\ has shown that small planets are common \citet{Burke2015}
