...
\added{\software{George \citep{Ambikasaran14}, Kepler Pipeline (Jenkins 2017b), Robovetter (https://github.com/nasa/kepler-robovetter), Marshall (https://sourceforge.net/projects/marshall/), Centroid Robovetter \citep{Mullally2017}, LPP Metric \citep{Thompson2015a}, Model-Shift Uniqueness Test \citep{Rowe2015cat}, Scipy package (https://www.scipy.org) }}
