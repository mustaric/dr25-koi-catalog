...
\def \nscrtces {13932} %number of scrambled TCEs after cleaning and no rogue
\def \ninvtces {15271} %number of inverted TCEs after cleaning and no rogue.
...
%Evaluating Completeness and Reliability
\section{The Completeness and Reliability Balance}
\input{section-CompAndReliability.tex}


%All the pieces that need to be brought together to make the catalog.
\section{The DR25 KOI Catalog}
