...
%\item DONE --\st{Better description/plot of how the errors for the score calculation was done. List which metrics were used to calculate the score.} [JEFF]
